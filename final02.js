...
lib.ssMetadata = [
		{name:"final02_atlas_1", frames: [[738,1106,932,661],[738,0,736,1104],[0,0,736,1563]]},
		{name:"final02_atlas_2", frames: [[378,1523,1320,190],[0,0,932,661],[566,1025,252,64],[1700,1603,252,64],[1700,1669,252,64],[934,642,736,460],[0,663,564,564],[1672,628,309,624],[1576,0,413,626],[1700,1254,300,347],[566,663,360,360],[0,1229,376,673],[934,0,640,640],[1194,1104,360,360],[566,1104,626,417]]}
];
...
(lib.CachedBmp_6 = function() {
	this.initialize(ss["final02_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_5 = function() {
	this.initialize(ss["final02_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.final02 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/final02_atlas_1.png", id:"final02_atlas_1"},
		{src:"images/final02_atlas_2.png", id:"final02_atlas_2"},
		{src:"sounds/celta_1.mp3", id:"celta_1"},
		{src:"sounds/guitarra.mp3", id:"guitarra"},
		{src:"sounds/audiomp3.mp3", id:"audiomp3"},
		{src:"sounds/musical100.mp3", id:"musical100"},
		{src:"sounds/piano.mp3", id:"piano"},
		{src:"sounds/saxofon.mp3", id:"saxofon"},
		{src:"sounds/violin.mp3", id:"violin"}
	],
	preloads: []
};
